...
head:
  - tag: title
    content: Quickstart tutorials for React, Next.js, and more | JS Training Grounds
description: Quickstart tutorials for intermediate JS topics like React, TypeScript, Next.js, Tailwind, and more.
template: splash
banner:
  content: |
    <a href="https://github.com/simpledevio/js-training-grounds" target="_blank">Star ⭐️ this project on GitHub!</a>
hero:
  tagline: Quickstart tutorials for intermediate JS topics like React, TypeScript, Next.js, Tailwind, and more.
  actions:
