...
- <a href="https://svelte.dev/docs/svelte/scoped-styles" target="_blank">scoped styles</a> / <a href="https://svelte.dev/tutorial/svelte/styling" target="_blank">Styling tutorial</a>
- <a href="https://svelte.dev/docs/svelte/style" target="_blank">style</a> / <a href="https://svelte.dev/tutorial/svelte/styles" target="_blank">The style directive tutorial</a>
- <a href="https://svelte.dev/docs/svelte/class" target="_blank">class</a> / <a href="https://svelte.dev/tutorial/svelte/classes" target="_blank">Classes tutorial</a>
- <a href="https://svelte.dev/docs/svelte/$state" target="_blank">$state</a> / <a href="https://svelte.dev/tutorial/svelte/state" target="_blank">State tutorial</a>
- <a href="https://svelte.dev/docs/svelte/if" target="_blank">if</a> / <a href="https://svelte.dev/tutorial/svelte/if-blocks" target="_blank">If blocks tutorial</a>
- <a href="https://svelte.dev/docs/svelte/bind" target="_blank">bind</a> / <a href="https://svelte.dev/tutorial/svelte/text-inputs" target="_blank">Text inputs tutorial</a>
- <a href="https://svelte.dev/docs/svelte/each" target="_blank">each</a> / <a href="https://svelte.dev/tutorial/svelte/keyed-each-blocks" target="_blank">Keyed each blocks tutorial</a>
- <a href="https://svelte.dev/docs/svelte/$derived" target="_blank">$derived</a> / <a href="https://svelte.dev/tutorial/svelte/derived-state" target="_blank">Derived state tutorial</a>
- <a href="https://svelte.dev/docs/svelte/$props" target="_blank">$props</a> / <a href="https://svelte.dev/tutorial/svelte/declaring-props" target="_blank">Props tutorial</a>
