...
Let's learn how to make components more flexible. Let's revisit the `HelloWorld.svelte` component and make it accept a `name` prop. This way, we can pass different names to it. To do this, we need to use the `$props()` rune.
