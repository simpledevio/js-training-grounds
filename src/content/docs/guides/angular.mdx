...
```html title="src/app/hello-world/hello-world.html"
<h1>Hello World</h1>
```
...
```html title="src/app/app.html" "-counter"
<app-counter />
```

Replace the contents of `counter.html` with a `<button>` that increments a count.

```html title="src/app/counter/counter.html"
...
```html title="src/app/counter/counter.html" {1-3}
@if (count() > 10) {
  <h1>Good job!</h1>
}
...
```html title="src/app/counter/counter.html" {3-5}
@if (count() > 10) {
  <h1>Good job!</h1>
  } @else {
...
```html title="src/app/counter/counter.html" {3-4}
@if (count() > 10) {
  <h1>Good job!</h1>
} @else if (count() > 5) {
  <h1>Not bad</h1>
...
```html title="src/app/app.html" "-todo-list"
<app-todo-list />
```
...
```html title="src/app/todo-list/todo-list.html"
<div>
<ul>
...
```html title="src/app/todo-list/todo-list.html" {2-9}
<div>
...
```html title="src/app/todo-list/todo-list.html" {14}
<div>
<form (ngSubmit)="addTask()" #taskForm="ngForm">
  <input
    [(ngModel)]="newTask"
...
```html title="src/app/todo-list/todo-list.html" {10-20, 24-28}
<div>
<form (ngSubmit)="addTask()" #taskForm="ngForm">
  <input
    [(ngModel)]="newTask"
...
```html title="src/app/hello-world/hello-world.html" "{{ name() }}"
<h1>Hello {{ name() }}</h1>
```
...
```html title="src/app/app.html" ' name="John"'
