...
- <a href="https://angular.dev/guide/templates/event-listeners" target="_blank">Adding event listeners</a> / <a href="https://angular.dev/tutorials/learn-angular/7-event-handling" target="_blank">Event handling tutorial</a>
- <a href="https://angular.dev/guide/templates/two-way-binding" target="_blank">Two-way binding</a> / <a href="https://angular.dev/tutorials/learn-angular/15-forms" target="_blank">Forms overview tutorial</a>
- <a href="https://angular.dev/guide/templates/control-flow" target="_blank">Control Flow</a> / <a href="https://angular.dev/tutorials/learn-angular/4-control-flow-if" target="_blank">@if tutorial</a>
- <a href="https://angular.dev/guide/templates/control-flow#repeat-content-with-the-for-block" target="_blank">Repeat content with the @for block</a> / <a href="https://angular.dev/tutorials/learn-angular/5-control-flow-for" target="_blank">@for tutorial</a>
- <a href="https://angular.dev/guide/signals#computed-signals" target="_blank">Computed signals</a>
- <a href="https://angular.dev/guide/components/inputs" target="_blank">Accepting data with input properties</a> / <a href="https://angular.dev/tutorials/learn-angular/8-input" target="_blank">Component input properties tutorial</a>
