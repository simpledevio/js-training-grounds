...
```html showLineNumbers=false
<p>This is some <a href="http://example.com/">link</a> text.</p>
```
</TabItem>
</Tabs>
...
```html showLineNumbers=false
<p>This is some <code>inline code</code> text.</p>
```
</TabItem>
</Tabs>
