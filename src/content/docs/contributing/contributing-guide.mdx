...
This tutorial is for people interested in contributing to **JS Training Grounds**. It will walk you through the process of forking the repo, setting up your local environment, and making contributions. 

Let's go over the steps below.

This tutorial assumes you're already familiar with Git and npm.

## Identify task

Before you can start contributing, you need to identify a task.

1. <a href="https://github.com/simpledevio/js-training-grounds/issues" target="_blank">Create an issue on the main repo</a> or volunteer to take on an issue
...
Now let's go over how to fork and clone the repo. We recommend using GitHub Desktop when contributing to this project. However, we've also included the relevant Git commands below if you prefer working with the command line.
...
Here's how to start working with the project locally.
